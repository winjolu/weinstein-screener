"""Re-exported from the shared package; implemented in market_core.neighbours.
...
screener.neighbours in a test would leave real callers bound to the
original — the failure that surfaced as an unexplained HTTP 403 when
sharadar.py moved.
"""
import sys

from market_core import neighbours as _shared
