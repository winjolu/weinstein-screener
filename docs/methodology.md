...
under which you simply do not buy, introduced with the instruction never
...
- Don't buy on a breakout with poor volume. If a resting buy-stop got you
  in anyway, sell it quickly.
...
advice — the market has no knowledge of what you paid. Two anchors
...
- **Limit purchases to those where the initial stop is no more than 15%
  ...
  frames it as a rule about which stocks you are permitted to buy —
